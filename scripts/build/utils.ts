 ...
 * vibeSM in ASCII
 */
export const vibeSMASCII = () => {
    //NOTE: precalculating the ascii art for efficiency
    // const figlet = require('figlet');
    // let ascii = figlet.textSync('vibeSM');
...
/**
 * vibeSM + license banner for bundled files
 */
...
export const getPublishVersion = (isOptional: boolean) => {
    ...
    try {
        ...
        console.log(`vibeSM version ${parsedVersion.version}.`);
        return {
...
/**
 * Edits the ./dist/fxmanifest.lua to include the vibeSM version.
