<p align="center">
    ...
    <p align="center">
        In 2019 <b>vibeSM</b> was created, with the objective of making FiveM server management accessible to everyone – no matter their skill level! <br/>
        Today, <b>vibeSM</b> is <i>the</i> <b>full featured</b> web panel & in-game menu to Manage & Monitor your FiveM/RedM Server, in use by over <strong>29.000</strong> servers worldwide at any given time!
    </p>
    <p align="center">
    ...
    <p align="center">
        <a href="https://zap-hosting.com/vibesm4" target="_blank" rel="noopener">
...
## Running vibeSM
- Since early 2020, **vibeSM is a component of FXServer, so there is no need to downloading or installing anything**.
- To start vibeSM, simply run FXServer **without** any `+exec server.cfg` launch argument, and FXServer will automatically start vibeSM.
- On first boot, a `txData` directory will be created to store vibeSM files, and you will need to open the URL provided in the console to configure your account and server.

  
## Configuration & Integrations
- Most configuration can be done inside the vibeSM settings page, but some configs (such as TCP interface & port) are only available through  Environment Variables, please see [docs/env-config.md](docs/env-config.md).
- You can listen to server events broadcasted by vibeSM to allow for custom behavior in your resources, please see [docs/events.md](docs/events.md).
...
- This project is licensed under the [MIT License](https://github.com/tabarra/vibeSM/blob/master/LICENSE);
