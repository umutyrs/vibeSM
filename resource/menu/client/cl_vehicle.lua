...
RegisterCommand('vibeSM:menu:spawnVehicle', function()
...
RegisterCommand('vibeSM:menu:deleteVehicle', function()
    if not menuIsAccessible then return end
    if not DoesPlayerHavePerm(menuPermissions, 'menu.vehicle') then
        return sendSnackbarMessage('error', 'nui_menu.misc.no_perms', true)
    end
...
RegisterCommand('vibeSM:menu:fixVehicle', function()
    if not menuIsAccessible then return end
    if not DoesPlayerHavePerm(menuPermissions, 'menu.vehicle') then
        return sendSnackbarMessage('error', 'nui_menu.misc.no_perms', true)
    end
...
RegisterCommand('vibeSM:menu:boostVehicle', function()
    if not menuIsAccessible then return end
    if not DoesPlayerHavePerm(menuPermissions, 'menu.vehicle') then
        return sendSnackbarMessage('error', 'nui_menu.misc.no_perms', true)
    end
