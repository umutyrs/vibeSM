...
RegisterCommand('vibeSM:menu:tpToCoords', function()
...
RegisterCommand('vibeSM:menu:tpToWaypoint', function()
    if not menuIsAccessible then return end
    if not DoesPlayerHavePerm(menuPermissions, 'players.teleport') then
        return sendSnackbarMessage('error', 'nui_menu.misc.no_perms', true)
    end
...
RegisterCommand('vibeSM:menu:tpBack', function()
    if not menuIsAccessible then return end
    if not DoesPlayerHavePerm(menuPermissions, 'players.teleport') then
        return sendSnackbarMessage('error', 'nui_menu.misc.no_perms', true)
    end
...
RegisterCommand('vibeSM:menu:clearArea', function()
    if not menuIsAccessible then return end
...
RegisterCommand('vibeSM:menu:healMyself', function()
    if not menuIsAccessible then return end
