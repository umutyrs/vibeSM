...
function updateServerCtx()
    stateBagServerCtx = GlobalState.vibeSMServerCtx
...
-- We only want suggestion for: /tx, /vibeSM-reauth
...
CreateThread(function()
    ...
    local suggestionsToRemove = {
        ...
        --Keybinds
        '/vibeSM:menu:openPlayersPage',
        '/vibeSM:menu:clearArea',
        '/vibeSM:menu:healMyself',
        '/vibeSM:menu:tpBack',
        '/vibeSM:menu:tpToCoords',
        '/vibeSM:menu:tpToWaypoint',
        '/vibeSM:menu:noClipToggle',
        '/vibeSM:menu:togglePlayerIDs',
        '/vibeSM:menu:boostVehicle',
        '/vibeSM:menu:deleteVehicle',
        '/vibeSM:menu:fixVehicle',
        '/vibeSM:menu:spawnVehicle',
...
function IsNuiRequestOriginValid(headers)
    ...
    if menuIsAccessible and sendPersistentAlert then
        local msg = ('ATTENTION! vibeSM received a NUI message from the origin "%s" which is not approved. This likely means that that resource is vulnerable to XSS which has been exploited to inject vibeSM commands. It is recommended that you fix the vulnerability or remove that resource completely. For more information: discord.gg/vibeSM.'):format(headers['Origin'])
