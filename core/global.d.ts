...
declare const vibeConfig: TxConfigs;

declare type VibeCoreType = import('./vibeSM').VibeCoreType;
declare const vibeCore: VibeCoreType;

declare type TxManagerType = import('./vibeManager').TxManagerType;
declare const vibeManager: TxManagerType;
