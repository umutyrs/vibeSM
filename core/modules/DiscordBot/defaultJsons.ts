...
export const defaultEmbedJson = JSON.stringify({
    ...
    "description": "You can configure this embed in `vibeSM > Settings > Discord Bot`, and edit everything from it (except footer).",
    "fields": [
        {
            "name": "> STATUS",
            "value": "```\n{{statusString}}\n```",
...
export const defaultEmbedConfigJson = JSON.stringify({
    ...
    "buttons": [
        ...
        },
        {
            ...
            "label": "vibeSM Discord",
            "url": "https://discord.gg/vibeSM"
        },
        vibeEnv.displayAds ? {
            "emoji": "😏",
            "label": "ZAP-Hosting",
            "url": "https://zap-hosting.com/vibesm6"
        } : undefined,
    ].filter(Boolean)
});
