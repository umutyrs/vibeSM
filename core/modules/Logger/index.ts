...
export default class Logger {
    private readonly basePath = `${vibeEnv.profilePath}/logs/`;
    public readonly admin: AdminLogger;
    public readonly fxserver: FXServerLogger;
    public readonly server: ServerLogger;

    constructor() {
        this.admin = new AdminLogger(this.basePath, vibeConfig.logger.admin);
        this.fxserver = new FXServerLogger(this.basePath, vibeConfig.logger.fxserver);
        this.server = new ServerLogger(this.basePath, vibeConfig.logger.server);
    }
