...
/**
 * Returns the boot divider, with the vibeSM and FXServer versions
 */
export const getBootDivider = () => {
    return getLogDivider(`vibeSM v${vibeEnv.vibeVersion} atop fxserver ${vibeEnv.fxsVersion} Starting`);
}
