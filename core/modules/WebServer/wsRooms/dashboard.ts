...
const getInitialData = (): DashboardDataEventType => {
    const svRuntimeStats = vibeCore.metrics.svRuntime.getRecentStats();

    return {
        // joinLeaveTally30m: vibeCore.FxPlayerlist.joinLeaveTally,
        playerDrop: {
            summaryLast6h: vibeCore.metrics.playerDrop.getRecentDropTally(6),
        },
        svRuntime: {
