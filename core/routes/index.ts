...
export { default as fileEditor_page } from './fileEditor/get.js';
export { default as fileEditor_save } from './fileEditor/save.js';
...
export { settings_getLocale, settings_saveLocale } from './settings/locale';
