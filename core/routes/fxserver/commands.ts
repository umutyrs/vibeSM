...
export default async function FXServerCommands(ctx: AuthedCtx) {
    ...
    if (action == 'profile_monitor') {
        ...
        ctx.admin.logAction('Profiling vibeSM instance.');

        const profileDuration = 5;
        const savePath = `${vibeEnv.profilePath}/data/txProfile.bin`;
        ...
        vibeCore.fxRunner.sendCommand('profiler', ['view', savePath], ctx.admin.name);
        return ctx.send<ApiToastResp>({
            type: 'success',
    ...
    //==============================================
        ...
        const publicAuthor = vibeCore.adminStore.getAdminPublicName(ctx.admin.name, 'message');
    ...
    //==============================================
        ...
        const kickReason = (parameter ?? '').trim() || vibeCore.translator.t('kick_messages.unknown_reason');
    ...
    //==============================================
        ...
        vibeCore.fxRunner.sendCommand('restart', [parameter], ctx.admin.name);
        return ctx.send<ApiToastResp>({
            type: 'warning',
    ...
    //==============================================
        ...
        vibeCore.fxRunner.sendCommand('start', [parameter], ctx.admin.name);
        return ctx.send<ApiToastResp>({
            type: 'warning',
    ...
    //==============================================
        ...
        vibeCore.fxRunner.sendCommand('ensure', [parameter], ctx.admin.name);
        return ctx.send<ApiToastResp>({
            type: 'warning',
    ...
    //==============================================
        ...
        vibeCore.fxRunner.sendCommand('stop', [parameter], ctx.admin.name);
        return ctx.send<ApiToastResp>({
            type: 'warning',
    ...
    //==============================================
        ...
        vibeCore.fxRunner.sendCommand('refresh', [], ctx.admin.name);
        return ctx.send<ApiToastResp>({
            type: 'warning',
