...
export default async function PlayerSearch(ctx: AuthedCtx) {
    ...
    const adminsIdentifiers = vibeCore.adminStore.getAdminsIdentifiers();
    const onlinePlayersLicenses = vibeCore.fxPlayerlist.getOnlinePlayersLicenses();
    ...
    */
    ...
    vibeCore.metrics.txRuntime.playersTableSearchTime.count(searchTime.stop().milliseconds);
