...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        '2xs': '0.625rem', // 10px
        'display-xl': ['5rem', { lineHeight: '1.17', letterSpacing: '-0.05em', fontWeight: '700' }], // 80px
        'display-lg': ['3.5rem', { lineHeight: '1.18', letterSpacing: '-0.045em', fontWeight: '700' }], // 56px
        'display-md': ['2.5rem', { lineHeight: '1.19', letterSpacing: '-0.04em', fontWeight: '600' }], // 40px
        'headline': ['1.75rem', { lineHeight: '1.21', letterSpacing: '-0.02em', fontWeight: '600' }], // 28px
        'card-title': ['1.375rem', { lineHeight: '1.18', letterSpacing: '-0.018em', fontWeight: '600' }], // 22px
      },
      letterSpacing: {
        eyebrow: '0.05em',
      },
      ...
      keyframes: {
        ...
        "pulse-glow": {
          ...
          "33%": { transform: "scale(1.1) translate(30px, -40px)", opacity: "0.95" },
          "66%": { transform: "scale(0.95) translate(-20px, 20px)", opacity: "0.75" }
        }
      },
      animation: {
