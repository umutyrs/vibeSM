...
import { fxRunnerStateAtom, vibeConfigStateAtom } from '@/hooks/status';
...
const controlButtonsVariants = cva(
    `h-10 sm:h-9 rounded-lg transition-all duration-300 active:scale-[0.92]
    flex flex-grow items-center justify-center flex-shrink-0
    border border-border/40 bg-foreground/5 backdrop-blur-md text-foreground/70 hover:text-foreground
    focus:outline-none disabled:opacity-30 disabled:pointer-events-none ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2`,
    {
        variants: {
            type: {
                default: "hover:bg-foreground/10 hover:border-border hover:shadow-[0_0_20px_hsl(var(--foreground)/0.05)]",
                destructive: "hover:bg-red-500/20 hover:border-red-500/40 hover:text-red-400 hover:shadow-[0_0_20px_rgba(239,68,68,0.25)]",
                warning: "hover:bg-amber-500/20 hover:border-amber-500/40 hover:text-amber-400 hover:shadow-[0_0_20px_rgba(245,158,11,0.25)]",
                success: "hover:bg-green-500/20 hover:border-green-500/40 hover:text-green-400 hover:shadow-[0_0_20px_rgba(34,197,94,0.25)]",
                info: "hover:bg-cyan-500/20 hover:border-cyan-500/40 hover:text-cyan-400 hover:shadow-[0_0_20px_rgba(6,182,212,0.25)]",
            },
        },
        defaultVariants: {
            type: "default",
...
export default function ServerControls() {
    ...
    if (vibeConfigState !== TxConfigState.Ready) {
        return (
            <div className='w-full text-center text-xs font-bold tracking-wider text-muted-foreground/60 uppercase py-1'>
