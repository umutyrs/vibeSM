...
import MultiHostingPage from "@/pages/MultiHosting";
...
const allRoutes: RouteType[] = [
    ...
    },
    {
        path: '/multi-hosting',
        title: 'Multi-Hosting',
        permission: 'settings.multihosting',
        Page: <MultiHostingPage />
    },
    {
    ...
    {
        path: '/server/file-editor',
        title: 'File Editor',
        permission: 'resources.file_editor',
        Page: <Iframe legacyUrl="fileEditor" />
    },
    {
        path: '/server/setup',
        title: 'Server Setup',
