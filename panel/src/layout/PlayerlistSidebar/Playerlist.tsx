    ...
    return (
        <div className="pt-2 px-2 flex gap-2">
            <div className="relative w-full">
                <Input
                    ref={inputRef}
                    className="h-8.5 bg-white/5 border-white/5 focus-visible:ring-primary focus-visible:border-primary focus-visible:ring-1 hover:bg-white/10 transition-all duration-300 placeholder:text-muted-foreground/60 text-white rounded-lg text-xs"
...
export default function Playerlist() {
    ...
    return (
        <>
            ...
            <div
                className={cn(
                    'text-center my-12 text-muted-foreground tracking-wide px-4',
                    virtualItems.length ? 'hidden' : 'block'
                )}
            >
                {playerlist.length && filterString ? (
                    <div className="space-y-1">
                        <div className="text-xs font-bold text-foreground/75 uppercase tracking-wider">No players found</div>
                        <div className="text-[10px] text-muted-foreground/60">Clear the filter to show all players</div>
                    </div>
                ) : (
                    <div className="space-y-1">
                        <div className="text-xs font-bold text-foreground/75 uppercase tracking-wider">No players online</div>
                        <div className="text-[10px] text-muted-foreground/60">Invite some friends to join in!</div>
                    </div>
                )}
            </div>
