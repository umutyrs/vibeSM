    ...
    return (
        <div className='fixed top-navbarvh w-full flex justify-center z-40'>
            <div className={cn(
                ...
                "group cursor-default transition-[height]",
...
export default function WarningBar() {
    ...
    if (offlineWarning) {
        return <InnerWarningBar
            ...
            description={<>
                The connection to the vibeSM server has been lost. <br />
        ...
        return <InnerWarningBar
            ...
            title={txUpdateData.isImportant
                ? 'This version of vibeSM is outdated.'
                : 'A patch (bug fix) update is available for vibeSM.'}
