...
export default function SystemLogPage({ pageName }: SystemLogPageProps) {
    ...
    return (
        <div className="dark text-primary flex flex-col h-full w-full bg-card/45 backdrop-blur-md border border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] md:rounded-xl overflow-clip">
