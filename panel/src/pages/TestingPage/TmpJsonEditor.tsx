...
loader.init().then(monaco => {
    monaco.editor.defineTheme('vibesm-dark', {
        base: 'vs-dark',
        inherit: true,
        rules: [],
        colors: {}
        ...
        <div className="flex flex-col h-full">
            ...
            <div className="flex-1 relative rounded-xl overflow-hidden border bg-[#1E1E1E]">
                ...
                <Editor
                    ...
                    theme="vibesm-dark"
                    beforeMount={(monaco) => {
                        monaco.editor.setTheme('vibesm-dark');
                    }}
                    options={{
...
const placeholderDescriptions = {
    ...
    serverName: 'This is the vibeSM-given name for this server. Can be changed in `vibeSM > Settings > Global`.',
            ...
            <div className="grow px-0 xs:px-3 md:px-0 w-full max-w-screen-lg mx-auto max-h-minx h-32">
                <DiscordJsonEditor
                    ...
                    description={(<>
                        ...
                        For information refer to <TxAnchor href="https://github.com/tabarra/vibeSM/blob/master/docs/discord-status.md">our docs</TxAnchor>.
                    </>)}
                />
            </div>
        </div>
