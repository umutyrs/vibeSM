    ...
    return <form onSubmit={handleSubmit} className='w-full text-left'>
        <CardContent className="pt-6 flex flex-col gap-4">
            ...
            <div className="flex items-center space-x-2 mt-2">
                ...
                >
                    I have read and agree to the <a href="https://fivem.net/terms" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">Creator PLA</a> as well as the <a href="https://github.com/tabarra/vibeSM/blob/master/LICENSE" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">vibeSM License</a>.
                </label>
            </div>
        </CardContent>
